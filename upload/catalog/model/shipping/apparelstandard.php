<?php
class ModelShippingApparelstandard extends Model {
    ...
    //
		//if (!$this->config->get('apparelstandard_geo_zone_id')) {
		//	$status = true;
		...
		$quote_data['apparelstandard'] = array(
			'code'         => 'apparelstandard.apparelstandard',
		...
		$method_data = array(
			'code'       => 'apparelstandard',
			'title'      => $this->language->get('text_title'),
			'quote'      => $quote_data,
			'sort_order' => $this->config->get('apparelstandard_sort_order'),
			'error'      => false
		);
